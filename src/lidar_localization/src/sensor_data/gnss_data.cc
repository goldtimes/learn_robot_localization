...
void GNSSData::UpdateXYZ() {
  ...
  geo_converter.Forward(latitude, longtitude, altitude, local_E, local_N,
                        local_U);
}
bool GNSSData::SyncData(std::deque<GNSSData>& UnsyncedData,
  ...
  synced_data.longtitude =
      front_data.longtitude * front_scale + back_data.longtitude * back_scale;
